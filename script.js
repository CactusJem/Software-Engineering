...
const newContainer = document.getElementById("topHeadlines");



// fetching news data from a website providing api

const apiKey = "0e27114c17254443882f26345c6d220b";
...
fetchData('business',5).then(add_topNews)
...
const observer = new IntersectionObserver((entries) => {
    entries.forEach((entry) => {
        if (entry.isIntersecting) {
            ...
            entry.target.classList.remove('show'); // Remove 'show' when out of view (optional)
        }
    });
});
